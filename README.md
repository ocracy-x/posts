...
* [@google-cloud/firestore - overview](https://cloud.google.com/nodejs/docs)
* [@cloud-cloud/firestore - server sdk](https://cloud.google.com/nodejs/docs/reference/firestore/latest)
